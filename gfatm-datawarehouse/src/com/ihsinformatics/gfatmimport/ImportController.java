...
// TODO: Enable on production				localDb.updateRecord("_implementation", new String[] {"status"}, new String[] {"RUNNING"}, "implementation_id='" + implementationId + "'");
	 ...
	 * @throws InstantiationException
	 */
	public void remoteSelectInsert(String selectQuery, String insertQuery, DatabaseUtil remoteDb, DatabaseUtil localDb)
			throws SQLException, InstantiationException,
			IllegalAccessException, ClassNotFoundException {
		DatabaseUtil.remoteSelectInsert(selectQuery, insertQuery, remoteDb, localDb);
	}
	...
	public void importPeopleData(DatabaseUtil remoteDb, int implementationId)
		...
		try {
			...
			remoteSelectInsert(selectQuery, insertQuery, remoteDb, localDb);
			// Insert new records
